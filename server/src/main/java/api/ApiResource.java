...
public class ApiResource {
    ...
    public Category categoryByName(
        ...
        try {
            ...
            throw new ApiException("Category lookup by name failed", e);
        }
    }
    ...
    public List<Book> suggestedBooksByCategoryName(
        ...
        try {
            ...
            throw new ApiException(String.format("Suggested books lookup via category name '%s' failed", categoryName), e);
        }
    }
